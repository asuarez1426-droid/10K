# 01 — Diagnóstico y metas

## Dónde estás hoy (julio 2026)

### Ingresos actuales: ~2.450.000 COP/mes (≈ $615 USD)

| Fuente | Monto | Naturaleza |
|---|---|---|
| Arriendo | 1.350.000 COP | Pasivo — no depende de tu tiempo. **No tocar.** |
| Cliente freelance | 700.000 COP | Activo — tu único cliente de servicios. Es tu semilla: caso de estudio y testimonio. |
| Transporte (novia) | 400.000 COP | Activo de bajo valor por hora. Candidato a eliminarse cuando la agencia supere 8M/mes. |

**Lectura honesta:** solo 700K de tus ingresos vienen de la habilidad que quieres escalar. El 10K no se construye "mejorando" lo actual — se construye con un motor nuevo (prospección + oferta high ticket) que hoy no existe. Eso es lo que este sistema instala.

### Activos con los que arrancas
...
- Audiencia: 19 seguidores IG, 25 conexiones LinkedIn → sin autoridad percibida todavía.
- Sin oferta empaquetada ni precio definido.
- Sin sistema de ventas: nunca has hecho volumen de llamadas de cierre (asumido — corrígeme si no).
- Sin línea base física medida.

## A dónde vas: metas mes a mes

Dos rutas en paralelo: la **realista** (lo que el sistema produce con conversión promedio) y la **estirada** (tu meta declarada, alcanzable solo con conversión en el extremo alto). Persigues la estirada, te evalúas contra la realista.
...
Lista completa y condiciones de desbloqueo en el **doc 08**: apartamento (2-3M arriendo), Suzuki Swift híbrido (72M), Samsung Book 6 Ultra, S26 Ultra, Watch Ultra, DJI Mic 3, FX6, luces, cuarto de grabación, aportes a padres y fundaciones de animales.

**Principio innegociable:** cada compra se desbloquea después de sostener un umbral de facturación 3 meses seguidos. Primero el ingreso, después el gasto. Los equipos que generan ingreso se desbloquean primero; los de estatus, al final.
